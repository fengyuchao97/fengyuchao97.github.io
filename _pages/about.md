...
I am currently a Associate Research Fellow at the College of Computer Science and Technology (College of Software, College of Artificial Intelligence), Zhejiang University of Technology, Hangzhou, China. [HomePage](https://homepage.zjut.edu.cn/fyc1/).

I received my Ph.D. degree from Zhejiang University of Technology under the supervision of Prof. [Jianwei Zheng](https://github.com/ZhengJianwei2/), and conducted postdoctoral research at Westlake University under the supervision of Prof. [Xin Yuan](https://scholar.google.com/citations?hl=zh-CN&user=cS9CbWkAAAAJ/).

My research focuses on remote sensing disaster perception and modeling, machine-centric scene change understanding, vision-language and multimodal information fusion, and generative simulation for data and sample synthesis.


📧 E-mail: <1149160349@qq.com> &emsp; [Google Scholar](https://scholar.google.com/citations?hl=zh-CN&pli=1&user=uB3Yhk0AAAAJ)

# 🔔 News
- *2026.09*:: &nbsp;Pytorch implementation of the paper: ASF-Tune: Adaptive Spatial-Frequency Tuning for Change Detection. <b>[[Codes](https://github.com/fengyuchao97/ASF-Tune)]</b>.
...
# First or Corresponding Auther
- ASF-Tune: Adaptive Spatial-Frequency Tuning for Change Detection<br>
Huijie Liang, Xiaoqin Zhang, Jianwei Zheng, QingShuai Wang, <b>Yuchao Feng*</b><br>
*Proceedings of the 31st ACM International Conference on Multimedia* (<b>ACMMM</b>), 2026. (CCF A) 
...
*IEEE Transactions on Geoscience and Remote Sensing* (<b>TGRS</b>), 2025. (SCI 1 TOP)
...
*IEEE Transactions on Circuits and Systems for Video Technology* (<b>TCSVT</b>), 2026. (IF 11.1, SCI 1 TOP)
...
*ACM Transactions on Multimedia Computing Communications and Applications* (<b>TOMM</b>), 2025. (CCF B) [[Pdf](https://dl.acm.org/doi/10.1145/3721135/)][[Code](https://github.com/fengyuchao97/ASCNet)]
...
# Others
- S²TA-Fuse: Semantic-Superpixel Tokenized Attention for Spatial Spectral Fusion<br>
